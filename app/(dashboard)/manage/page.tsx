...
function page() {
  ...
  <div className="container mx-auto px-6 flex flex-col py-8">
    <h1 className="text-3xl font-bold mb-1">Manage</h1>
    ...
    <div className="container flex flex-col gap-4 p-4">
        <Card>
            <CardHeader>
               <CardTitle className="text-2xl font-semibold tracking-tight">Currency</CardTitle>
               <CardDescription>
...
function CategoryList({ type }: { type: TransactionType }) {
  ...
  <div className="flex items-center gap-3">
    {type === "expense" ? (
      <TrendingDown className="h-12 w-12 rounded-xl bg-red-400/10 p-2 text-red-500" />
    ) : (
      <TrendingUp className="h-12 w-12 rounded-xl bg-emerald-400/10 p-2 text-emerald-500" />
    )}
    <div>
            ...
            !dataAvailable && (
                ...
                justify-center">
                    <p>
                        ...
                        'm-1', type === 'income' ? 'text-emerald-500' : 'text-red-500'
                        )}>
                            {type}
                            </span>
                             categories yet
